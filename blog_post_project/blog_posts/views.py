...
from blog_post_project.models import BlogPost
from blog_post_project.blog_posts.forms import BlogPostForm
...
def create_post():
    ...
    return render_template('create_post.html',form=form,title='Post something!')
...
def update(blog_post_id):
    ...
    return render_template('create_post.html', title='Update your post',form=form)
